...
const paths = {
    ...
    src: {
        ...
        scss: {
            dir: './src/scss',
            files: './src/scss/**/*',
            main: './src/scss/config/default/app.scss'
        },
        icon: {
            dir: './src/scss',
        ...
        bootstrap: {
            files: './src/scss/config/default/bootstrap.scss',
            typeFiles: './src/scss/config/default/bootstrap.scss',
            components: './src/scss/components/*',
            light: './src/scss/config/default/_theme*',
            variables: './src/scss/config/default/_variables*',
        },
        custom: {
            dir: './src/scss/config/default/custom.scss',
            files: './src/scss/config/default/custom.scss',
            main: './src/scss/config/default/custom.scss'
        },
    }
};
